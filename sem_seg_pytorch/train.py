...
for epoch in range(num_epochs) :
    highest_iou = train(model = net, train_loader = trainloader, val_loader = valloader, loss_function = criterion, optimiser = optimizer, epoch = epoch, num_epochs = num_epochs, savename = 'saved_models/new_road5.pt', highest_iou = highest_iou)
